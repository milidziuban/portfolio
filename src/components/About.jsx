    ...
    return (
        <div className="background">
            ...
            <div className="study">
                ...
                <a href={CoderBasico}> Ver certificado </a>
                <p>
                    Diseño UX/UI Avanzado (2022 - Actualidad) CoderHouse
                </p>
                <a href={CoderAvanzado}> Ver certificado </a>
                <p>
                    Introducción a HTML, CSS y JavaScript (2022 Junio- Agosto) HackAcademy
                </p>
                <a href='https://plataforma.ha.dev/certificates/l1gnabcpct'> Ver certificado </a>

                <p>
                    Full Stack Developer (2022 Septiembre - 2023 Enero) Bootcamp SoyHenry
                </p>
                <a href="https://certificates.soyhenry.com/cert?id=b17f00b7-9529-49d2-9088-9da174a8d261"> Ver certificado </a>
            </div>
        </div>
    )
}